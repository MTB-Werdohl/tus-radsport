...
**Status:** Phase 0–3 live + Phase-4-Grundlage — SQL [`supabase-media-storage-paths.sql`](supabase-media-storage-paths.sql), [`supabase-media-move.sql`](supabase-media-move.sql) in Supabase  
