-- Abstimmung/Zusage an Termin-Ende koppeln
--
-- Gleiche Logik wie Termin-Karten (endDay >= heute):
-- docs/supabase-anonymize-upcoming-feedback.sql → is_termin_still_upcoming()
--
-- Nach Phase-4a-Basis und is_termin_still_upcoming ausführen.
...
begin
  ...
  v_recurring :=
    coalesce(v_termin.recurring, false);
