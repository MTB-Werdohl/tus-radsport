...
| Bereich | Dateien |
|---------|---------|
| Profil-Tab | `assets/js/member/member-render.js`, `member-recaps.js`, `member-page.js` |
...
Mitglieder sehen drei Listen: **Rückblick fehlt** (eigene vergangene Termine ohne Recap), **In Bearbeitung** (`status=draft`), **Veröffentlicht**. Speichern nur als Entwurf — Veröffentlichen ausschließlich Vorstand.
